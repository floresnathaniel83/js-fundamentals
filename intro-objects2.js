...
var getFullNames = function (arr) {
    var newStr = ''
    var newArr = [] //I made an error by putting the newArr var inside of the for loop rather than outside, why does it work outside of the for loop?
    for(var i = 0; i < arr.length; i++){
        newStr = arr[i].first + ' ' + arr[i].last
        newArr.push(newStr)
      }
